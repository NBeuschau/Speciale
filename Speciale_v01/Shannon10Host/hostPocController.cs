...
namespace Shannon10Host
{
    class hostPocController
    {
        private static string nameOfMachine = "PocTester2";
        private static string nameofStartUpSnapshot = "sh10startup";
        ...
        public static void getPocHP1Host()
        {
            ...
            try
            {
                ...
                responseString = client.GetStringAsync("http://192.168.8.102/v1/index.php/getsh10host").Result;
