...
namespace Shannon10POC
{
    class FileMon
    {
        ...
        private static void OnChanged(object source, FileSystemEventArgs e)
        {
            ...
            if (   e.FullPath.Contains(@"C:\Users\PoC2\Desktop")
                || e.FullPath.Contains(@"C:\Users\PoC2\Documents")
                || e.FullPath.Contains(@"C:\Users\PoC2\Downloads")
                || e.FullPath.Contains(@"C:\Users\PoC2\Videos"))
            {
        ...
        private static void OnRenamed(object source, RenamedEventArgs e)
        {
            ...
            if (  e.OldFullPath.Contains(@"C:\Users\PoC2\Desktop")
               || e.OldFullPath.Contains(@"C:\Users\PoC2\Documents")
               || e.OldFullPath.Contains(@"C:\Users\PoC2\Downloads")
               || e.OldFullPath.Contains(@"C:\Users\PoC2\Videos"))
            {
