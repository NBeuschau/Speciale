...
namespace Shannon15Host
{
    class hostPocController
    {
        private static string nameOfMachine = "PocTester3";
        private static string nameofStartUpSnapshot = "sh15startup";
        ...
        public static void getPocHP1Host()
        {
            ...
            try
            {
                ...
                responseString = client.GetStringAsync("http://192.168.8.102/v1/index.php/getsh15host").Result;
